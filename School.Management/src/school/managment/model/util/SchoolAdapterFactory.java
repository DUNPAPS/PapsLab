...
public class SchoolAdapterFactory extends AdapterFactoryImpl {
	...
	protected SchoolSwitch<Adapter> modelSwitch =
		new SchoolSwitch<Adapter>() {
			...
			@Override
			public Adapter caseStudentDataType(StudentDataType object) {
				return createStudentDataTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link school.managment.model.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link school.managment.model.RecordType <em>Record Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link school.managment.model.StudentDataType <em>Student Data Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStudentDataTypeAdapter() {
		return null;
	}
